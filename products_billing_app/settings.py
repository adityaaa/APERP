...
ALLOWED_HOSTS = ['aperp-8ca6bf9ae3f3.herokuapp.com/']
...
ROOT_URLCONF = 'products_billing_app.urls'
...
WSGI_APPLICATION = 'products_billing_app.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'billing_app' / 'static']  # Corrected path here
